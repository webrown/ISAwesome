...
class Instruction {
  public:
    virtual ~Instruction();
    virtual void decode(StageData *sd, Register *r, int *wait)=0;
    virtual void execute(StageData *sd, int *wait)=0;
    virtual void memory(StageData *sd, MemoryStructure *, int *wait)=0;
    virtual void writeBack(StageData *sd, Register *r, int *wait)=0;
