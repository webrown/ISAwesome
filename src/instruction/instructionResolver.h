...
class InstructionResolver{
  public:
    ...
    QMap<uint, short> argTable;
    QMap<uint, QString> opcodeTable;
//    const QTable<uint, Instruction> instructionTable;
    void set(QString instruction, uint opcode, short argumentMask){
      nameTable[instruction] = opcode;
      opcodeTable[opcode] = instruction;
      argTable[opcode] = argumentMask;
    }
