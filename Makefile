...
$(TARGET): src/gui/ui_pisa.h src/gui/ui_newfiledialog.h src/gui/ui_newcachedialog.h $(OBJECTS)  
...
distclean: clean 
	-$(DEL_FILE) $(TARGET) 
	-$(DEL_FILE) /home/younglee/Dropbox/Projects/c++/PISA/target_wrapper.sh .qmake.stash
	-$(DEL_FILE) Makefile
...
check: first
	cd bin && /home/younglee/Dropbox/Projects/c++/PISA/target_wrapper.sh $(TESTRUNNER) ./$(QMAKE_TARGET) $(TESTARGS)
...
compiler_moc_header_make_all: build/moc_mainwindow.cpp build/moc_codeeditor.cpp build/moc_newfiledialog.cpp build/moc_newcachedialog.cpp build/moc_cacheview.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) build/moc_mainwindow.cpp build/moc_codeeditor.cpp build/moc_newfiledialog.cpp build/moc_newcachedialog.cpp build/moc_cacheview.cpp
...
compiler_uic_make_all: src/gui/ui_pisa.h src/gui/ui_newfiledialog.h src/gui/ui_newcachedialog.h
compiler_uic_clean:
	-$(DEL_FILE) src/gui/ui_pisa.h src/gui/ui_newfiledialog.h src/gui/ui_newcachedialog.h
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/usr/tests/pisa || mkdir -p $(INSTALL_ROOT)/usr/tests/pisa
	-$(INSTALL_PROGRAM) bin/$(QMAKE_TARGET) $(INSTALL_ROOT)/usr/tests/pisa/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/usr/tests/pisa/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/tests/pisa/ 
